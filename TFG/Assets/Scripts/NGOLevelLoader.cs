...
public class NGOLevelLoader : NetworkBehaviour
{

    // instance
    public static NGOLevelLoader instance;

    public int nextLevel;
    public bool passLevel;
    public NGONetworkManager networkManager;
    public NGOTaskController taskController;

    public GameObject platform;
    public bool platformActive;
    private Vector3 minBoundingBox, maxBoundingBox;
